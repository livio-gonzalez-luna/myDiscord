...
--
-- Table structure for table `channelparticipants`
--

DROP TABLE IF EXISTS `channelparticipants`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `channelparticipants`
--

LOCK TABLES `channelparticipants` WRITE;
/*!40000 ALTER TABLE `channelparticipants` DISABLE KEYS */;
/*!40000 ALTER TABLE `channelparticipants` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-03-22 14:37:55
